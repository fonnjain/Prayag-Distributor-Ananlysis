...
runMigrations()
  ...
  // All blocking startup work (migrations, anchor restore, registry load) ran
  // before app.listen() — the server is fully initialised the moment it opens
  // the port.  Signal the readiness gate so routes stop returning 503.
  setServerReady();
