...
import { Sun, Moon, Printer, Menu, X, BarChart3, Map, LayoutGrid, Package, TrendingUp, Database, Bot, HardDrive } from "lucide-react";
...
const AREAS = [
  ...
  { id: "drive", label: "Drive Files", icon: HardDrive, component: DriveFiles },
